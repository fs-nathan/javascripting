...
This fork includes a complete Vietnamese localization:

| File | Purpose |
|------|---------|
| `i18n/vi.json` | Menu labels + workshop UI strings |
| `i18n/footer/vi.md` | Footer help link |
| `i18n/troubleshooting_vi.md` | Verify-fail troubleshooting |
| `problems/*/problem_vi.md` | Challenge instructions (20 exercises) |
| `problems/*/solution_vi.md` | Success messages |
| `README.vi.md` | Setup guide in Vietnamese |

Vietnamese is the default language (`defaultLang: 'vi'` in `index.js`). Users can switch to English via **CHOOSE LANGUAGE** in the menu.
...
See [README.vi.md](README.vi.md) for full instructions.
