...
## Usage
Tell Cursor: "Fix issue: [describe the issue]" or "Fix bug in [file/module]"
...
- Ensure code follows `.cursor/rules/code-style.mdc`
- Handle errors per `.cursor/rules/error-handling.mdc`
