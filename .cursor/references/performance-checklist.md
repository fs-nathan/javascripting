...
For deep performance reviews (12 principles, review/generate/refactor behavior), use the **`frontend-performance`** skill at `.cursor/skills/frontend-performance/SKILL.md`.
